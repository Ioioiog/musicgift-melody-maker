...
export const aboutTranslations = {
  ...
  aboutMainPhilosophy: "La MusicGift credem că muzica este cea mai pură formă de emoție. În fiecare poveste personală există o melodie necântată, o emoție care merită să prindă viață. Transformăm aceste emoții în melodii adevărate, create de artiști adevărați, pentru oameni adevărați.",
  aboutCompanyStory1: "MusicGift s-a născut din dorința de a aduce oamenilor un cadou unic: o melodie creată special pentru ei. Într-o lume în care totul devine rapid și superficial, am ales să investim timp, suflet și pasiune în fiecare creație muzicală.",
  aboutCompanyStory2: "Fondat de Mihai Gruia, producător muzical și fost membru al trupei internaționale Akcent, MusicGift combină experiența de scenă și studio cu emoția sinceră a poveștilor personale.",
  mihaiGruiaDescription: "Producător muzical și compozitor, membru fondator Akcent – una dintre cele mai de succes trupe pop românești la nivel internațional, cu hituri celebre precum 'That's My Name', 'Kylie' și 'Stay with Me'. După succesul Akcent, Mihai și-a continuat cariera artistică prin proiectul TWO și s-a implicat în producția muzicală pentru artiști de top. Astăzi coordonează echipa MusicGift și DOMG Studio, aducând expertiza sa în fiecare proiect livrat.",
  mangoRecordsDescription: "Mango Records, fondată și coordonată de Mihai Gruia, este o casă de discuri independentă din România, specializată în lansarea și distribuția de muzică originală la nivel internațional. A promovat artiști de succes precum TWO (ex-Akcent), DOMG, Mellina, Red Blonde, Pitt Leffer, Katerina și Vulgaris. Cu peste 1000 de piese distribuite global pe Spotify, Apple Music și YouTube, Mango Records contribuie activ la scena muzicală contemporană.",
