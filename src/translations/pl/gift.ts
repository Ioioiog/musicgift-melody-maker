export const giftTranslations = {
  ...
  tellUsWhoGiftFor: "Powiedz nam, dla kogo jest ten prezent.",
  yourName: "Twoje Imię",
  ...
  cardValue: "Wartość karty",
  uniqueGiftCardCode: "Unikalny kod karty podarunkowej",
  recipient: "Odbiorca",
  from: "Od",
  ...
  giftCardSummary: "Podsumowanie Karty Podarunkowej",
  amount: "Kwota",
  design: "Design",
  ...
  // Gift card details
  giftCardDetails: "Szczegóły Karty Podarunkowej",
  validGiftCard: "Ważna Karta Podarunkowa",
  giftCardValue: "Wartość Karty Podarunkowej",
  messageFromSender: "Wiadomość od nadawcy",
  choosePackage: "Wybierz Pakiet",
  selectPackageToRedeem: "Wybierz pakiet, który chcesz wykorzystać z kartą podarunkową",
  ...
  stepDesign: "Design",
  stepReview: "Przegląd",
  selectPerfectValue: "Wybierz idealną wartość dla swojego muzycznego prezentu.",
  popular: "Popularne",
  enterCustomAmount: "Wprowadź Niestandardową Kwotę",
  tellUsWhoGiftFor: "Powiedz nam, dla kogo jest ten wyjątkowy prezent.",
  enterYourFullName: "Wprowadź swoje pełne imię",
  enterRecipientName: "Wprowadź imię odbiorcy",
  writeHeartfeltMessage: "Napisz szczerą wiadomość...",
  chooseDeliveryDate: "Wybierz datę dostawy",
  confirmDetailsBeforePayment: "Potwierdź swoje dane przed przystąpieniem do płatności.",
