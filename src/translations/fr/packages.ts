export const packagesTranslations = {
  ...
  artistTagline: "Lancez votre carrière musicale avec un top titre",
  ...
  artistInclude3: "Copropriété 50/50 du master",
  ...
  giftInclude2: "Livraison instantanée par email",
  ...
  didYouKnowPersonal1Title: "La musique déclenche les souvenirs",
  didYouKnowPersonal1Desc: "Les études montrent que les chansons personnalisées peuvent déclencher des souvenirs émotionnels plus forts que la musique générique, les rendant parfaites pour les occasions spéciales.",
  ...
  didYouKnowPremium1Desc: "Les chansons distribuées mondialement peuvent atteindre plus de 100 millions d'auditeurs potentiels sur toutes les plateformes de streaming majeures.",
  didYouKnowPremium2Title: "Engagement vidéo",
  didYouKnowPremium2Desc: "Les vidéos musicales reçoivent 1200% plus de partages que le texte et les images combinés sur les plateformes de réseaux sociaux.",
  
  // Business package facts
  didYouKnowBusiness1Title: "Une marque avec identité audio est retenue 5 fois plus facilement",
  didYouKnowBusiness1Desc: "Une identité audio professionnelle n'est pas qu'un luxe – c'est une signature unique et reconnaissable qui vous différencie sur un marché encombré, crée une connexion émotionnelle forte avec votre audience, augmente l'impact des publicités et du contenu numérique, et améliore la confiance et le professionnalisme perçus.",
  didYouKnowBusiness2Title: "Votre marque mérite d'avoir un son unique",
  didYouKnowBusiness2Desc: "Grâce au forfait Business MusicGift, nous composons pour vous une pièce originale, parfaitement adaptée à votre marque, votre audience et vos valeurs. Elle peut être utilisée dans les publicités, les clips de réseaux sociaux, les podcasts, les spots radio ou sur votre site web – partout où vous voulez être entendu.",
  
  // Artist package facts
  didYouKnowArtist1Title: "La première impression compte",
  didYouKnowArtist1Desc: "Les professionnels de l'industrie musicale décident dans les 15 premières secondes si une chanson a du potentiel, soulignant l'importance d'une production professionnelle.",
  didYouKnowArtist2Title: "Succès du streaming",
  didYouKnowArtist2Desc: "Les artistes indépendants représentent 43% du marché musical mondial, prouvant qu'une production de qualité peut rivaliser avec les grandes maisons de disques.",
  ...
  didYouKnowGift2Desc: "Partager la musique renforce les relations en libérant de l'ocytocine, l'« hormone du lien », rendant les cadeaux musicaux particulièrement significatifs.",
  
  // General facts
  didYouKnowGeneral1Title: "Musique et émotions",
  didYouKnowGeneral1Desc: "La musique active les mêmes voies neuronales que la nourriture, le sexe et les drogues, expliquant pourquoi les chansons personnalisées sont si gratifiantes.",
