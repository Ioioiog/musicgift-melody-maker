...
export const howItWorksTranslations = {
  ...
  howItWorksProcessTitle: "Comment Notre Processus Fonctionne",
  howItWorksProcessSubtitle: "De votre histoire à votre chanson personnalisée en 4 étapes simples",
  step: "Étape",
  
  // Step 1: Choose Your Package
  step1Title: "Choisissez Votre Forfait",
  step1Description: "Chaque chanson spéciale commence par le choix parfait",
  step1DetailsIntro: "Chaque chanson spéciale commence par le choix parfait. Explorez notre sélection de forfaits soigneusement conçus et choisissez celui qui correspond le mieux à votre occasion, sentiment et budget — qu'il s'agisse d'un cadeau d'anniversaire, d'une surprise romantique, d'un cadeau de mariage ou de votre première danse, ou peut-être d'un cadeau unique juste parce que vous en avez assez d'apporter un autre parfum à l'anniversaire de quelqu'un !",
  ...
  step2Description: "C'est votre moment pour vous ouvrir",
  step2DetailsIntro: "C'est votre moment pour vous ouvrir. Votre chanson sera façonnée par l'histoire que vous nous racontez — les moments qui vous ont ému, les personnes qui comptent et les souvenirs que vous voulez préserver à travers la musique.",
  step2DetailsTitle: "Vous pouvez inclure :",
  step2Detail1: "Événements mémorables, jalons personnels et souvenirs émouvants",
  ...
  step2DetailsFooter: "Plus vous partagez, plus votre chanson sera personnalisée et percutante.",
  
  // Step 3: We Create the Music
  step3Title: "Nous Créons la Musique",
  step3Description: "Notre équipe se met au travail pour créer votre chanson",
  ...
  step3Detail3: "Nous ajoutons les voix et nous assurons que l'interprétation soit en parfaite harmonie avec vos exigences",
