  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-8">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <a href="https://anpc.ro/ce-este-sal/" target="_blank" rel="noopener noreferrer" className="block hover:opacity-90 transition-opacity duration-300 hover:scale-105 min-h-[100px] flex items-center justify-center">
          ...
          <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="block hover:opacity-90 transition-opacity duration-300 hover:scale-105 min-h-[100px] flex items-center justify-center">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <a href="https://stripe.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
          ...
          <div className="relative flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
          ...
          <div className="flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          <a href="https://www.billionareboysclub.ro" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
          ...
          <a href="https://www.mgnews.ro" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
          ...
          <a href="https://www.evonews.ro" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity duration-300 hover:scale-105 min-h-[100px]">
