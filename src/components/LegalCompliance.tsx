...
const LegalCompliance = () => {
  return <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="block bg-white/20 backdrop-blur-sm border border-black/10 rounded-xl p-3 hover:bg-white/30 transition-all duration-300 hover:scale-105 shadow-lg">
            <img src="/lovable-uploads/e923f28a-a040-43f3-a749-31a8b2e479b3.png" alt="Soluționarea online a litigiilor" className="max-w-[160px] w-full h-auto mx-auto hover:opacity-90 transition" />
          </a>
        </div>
      </div>
