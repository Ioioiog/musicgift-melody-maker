  ...
  return (
    <section className="relative h-30 bg-black overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-between max-w-7xl mx-auto px-8">
        ...
        <motion.div 
          className={`flex items-center space-x-4 transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}
        ...
        >
          <div className="relative">
            ...
            <div className="relative bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-3">
              <IconComponent 
                size={32} 
          ...
          <div>
            ...
            <div className="flex items-center mt-1">
              <div className="w-8 h-0.5 bg-purple-400 rounded-full"></div>
              <div className="text-xs text-purple-200 ml-2 font-medium uppercase tracking-wider">
        ...
        {/* Center - Main message */}
        <motion.div 
          className={`flex-1 max-w-2xl mx-8 transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}
