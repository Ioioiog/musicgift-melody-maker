    ...
    <section className="py-20 px-4 text-white relative overflow-hidden min-h-screen flex items-center" style={backgroundStyle}>
      ...
      <div className="max-w-6xl mx-auto relative z-10 w-full">
        ...
        >
          ...
          >
            <motion.div
              className="bg-gradient-to-br from-purple-400 to-pink-400 p-4 rounded-full shadow-lg"
          ...
          >
            <motion.a 
              href="/order" 
              className="group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-full text-lg transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 flex items-center gap-3 min-w-[200px] justify-center" 
