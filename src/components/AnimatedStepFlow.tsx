  ...
  return <div className="max-w-6xl mx-auto px-4 h-full">
      <div className="flex flex-col lg:flex-row items-start gap-8 p-8 max-w-6xl mx-auto">
        ...
        <div className="flex lg:flex-col gap-6">
          ...
          return <motion.div key={idx} onClick={() => handleStepClick(idx)} className={`cursor-pointer w-28 h-28 rounded-full flex items-center justify-center shadow-xl transition-all duration-300 relative overflow-hidden group
                  ${isActive ? 'bg-gradient-to-br from-purple-500 to-purple-700 text-white scale-110 shadow-purple-300/50' : isPrevious ? 'bg-gradient-to-br from-green-400 to-green-600 text-white scale-105 shadow-green-300/30' : 'bg-white text-gray-600 hover:bg-gray-50 hover:scale-105 shadow-gray-200/50'}`} whileHover={{
            ...
            scale: isActive ? 1.05 : 1.0
              ...
              scale: 1
                ...
                {/* Icon */}
                <IconComponent className={`relative z-10 transition-all duration-300 ${isActive ? 'w-10 h-10' : 'w-8 h-8'}`} strokeWidth={isActive ? 2.5 : 2} />
              </motion.div>;
        })}
        </div>
        ...
        <div className="lg:hidden w-full mb-4">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-purple-600 h-2 rounded-full transition-all duration-100 ease-out" style={{
            width: `${progress}%`
          }} />
          </div>
        </div>
            ...
            duration: 0.3
              ...
              <div className="mb-6 relative z-10">
                ...
                <ul className="space-y-1 ">
                  {steps[activeStep].details.listItems.map((item, index) => <li key={index} className="flex items-start gap-3">
