                  ...
                  delay: 0.6
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        {steps.map((_, index) => <motion.div key={index} className={`h-1.5 rounded-full transition-all duration-500 ${index === activeStep ? 'bg-gradient-to-r from-purple-500 to-purple-600 w-6' : index < activeStep ? 'bg-green-400 w-2' : 'bg-gray-200 w-2'}`} whileHover={{
                        scale: 1.2
                      }} />)}
                      </div>
                    </div>
