                    ...
                    <div className="flex items-center justify-between w-full pr-4">
                      <div className="flex items-center space-x-4">
                        {selectedPackageData.tag && (
                          <Badge className={`${getTagColor(selectedPackageData.tag)} text-sm px-3 py-1.5 font-medium`}>
            ...
            <CardContent className="pt-0">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="text-right">
                  ...
                  {selectedPackageData.tag && (
                    <Badge className={`${getTagColor(selectedPackageData.tag)} mt-2 inline-flex text-sm px-3 py-1.5 font-medium`}>
                      <div className="flex items-center gap-1.5">
                        {getTagIcon(selectedPackageData.tag)}
                        <span>{t(selectedPackageData.tag)}</span>
                      </div>
