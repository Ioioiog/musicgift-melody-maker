      ...
      <Card className="bg-white/10 backdrop-blur-sm border border-white/30">
        <CardContent className="p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <Label htmlFor="email" className="text-white/80 flex items-center gap-1">
              ...
              />
              {hasError('email') && <p className="text-red-400 text-sm mt-1">{errors.email}</p>}
            </div>

            {/* Row 2: Invoice Type | Phone (optional) */}
            <div>
            ...
            <div>
              ...
              />
              {hasError('phone') && <p className="text-red-400 text-sm mt-1">{errors.phone}</p>}
            </div>
