...
const ContactLegalStep: React.FC<ContactLegalStepProps> = ({
  ...
  const getErrorClass = (fieldName: string) => 
    hasError(fieldName) ? 'border-red-500 bg-red-500/10' : 'bg-white/10 border-white/30';
        ...
        <CardContent className="p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                id="invoiceType"
                className={`w-full rounded px-3 py-2 text-white/80 focus:outline-none focus:ring-2 focus:ring-orange-500 ${getErrorClass('invoiceType')}`}
              ...
              {hasError('invoiceType') && (
                <p className="text-red-400 text-sm mt-1">{errors.invoiceType}</p>
              )}
            </div>
              ...
              <>
                ...
                <div>
                  ...
                  <Input
                    type="text"
                    id="vatCode"
                    className={getErrorClass('vatCode')}
                    value={formData.vatCode || ''}
                    onChange={(e) => onInputChange('vatCode', e.target.value)}
                    placeholder={t('enterVatCode', 'Enter VAT code')}
                  />
                  {hasError('vatCode') && (
                    <p className="text-red-400 text-sm mt-1">{errors.vatCode}</p>
                  )}
                </div>
                <div>
                  ...
                  <Input
                    ...
                    className={getErrorClass('registrationNumber')}
                    value={formData.registrationNumber || ''}
                    onChange={(e) => onInputChange('registrationNumber', e.target.value)}
                    placeholder={t('enterRegistrationNumber', 'Enter registration number')}
                  />
                ...
                <div>
                  ...
                  <Input
                    type="text"
                    id="companyAddress"
                    className={getErrorClass('companyAddress')}
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={getErrorClass('representativeName')}
                    value={formData.representativeName || ''}
                    onChange={(e) => onInputChange('representativeName', e.target.value)}
                    placeholder={t('enterRepresentativeName', 'Enter representative name')}
                  />
                  {hasError('representativeName') && (
                    <p className="text-red-400 text-sm mt-1">{errors.representativeName}</p>
                  )}
                </div>
              </>
            ) : (
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              {hasError('acceptMentionObligation') && (
                <p className="text-red-400 text-sm ml-6">{errors.acceptMentionObligation}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {hasError('acceptDistribution') && (
                <p className="text-red-400 text-sm ml-6">{errors.acceptDistribution}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {hasError('finalNote') && (
                <p className="text-red-400 text-sm ml-6">{errors.finalNote}</p>
              )}
            </div>
          </div>
        </CardContent>
