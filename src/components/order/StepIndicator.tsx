    ...
    return (
      <div className={cn("mb-2", className)}>
        ...
        <div className="w-full bg-gray-200 rounded-full h-1 mb-1">
          <div 
            className="bg-gradient-to-r from-orange-500 to-orange-600 h-1 rounded-full transition-all duration-700 ease-in-out" 
  ...
  return (
    <div className={cn("mb-4", className)}>
      ...
      <div className="relative mb-3">
        ...
        <div 
          className="absolute top-4 left-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full transition-all duration-700 ease-in-out" 
          style={{ width: `${progressPercentage}%` }} 
        />
            ...
            <div key={step.number} className="flex flex-col items-center group">
              <div className={`
                ...
                ${step.isCompleted 
                  ...
                  : step.isCurrent 
                    ? 'bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-xl scale-105 ring-2 ring-orange-200' 
              ...
              `}>
                ...
                {step.isCurrent && (
                  <div className="w-1.5 h-1.5 bg-orange-600 rounded-full mx-auto mt-0.5 animate-pulse" />
                )}
              </div>
            </div>
          ))}
