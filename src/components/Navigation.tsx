  ...
  return <>
      ...
      <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-[100]">
        <Link to="/" className="block">
          <img src="/lovable-uploads/9d0d10ef-2340-4632-8df0-f5058547a0c9.png" alt="MusicGift Logo" className="h-60 w-40 transition-transform duration-100 ease-in-out hover:scale-200\n" />
        </Link>
      </div>
