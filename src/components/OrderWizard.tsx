...
const OrderWizard: React.FC<OrderWizardProps> = ({
  ...
  return <div className="container py-8 mx-0">
      <Card className="bg-gradient-to-br from-purple-600/90 to-purple-800/90 backdrop-blur-md border border-purple-400/30 hover:border-purple-300/50 transition-all duration-300 shadow-xl">
