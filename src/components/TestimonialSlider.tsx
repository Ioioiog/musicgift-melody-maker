    ...
    return <div className="py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3, 4, 5, 6].map(i => <div key={i} className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          return <motion.div key={testimonial.id} initial={{
            ...
            delay: index * 0.05
                ...
                {type === 'text-only' && <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 hover:border-white/30 transition-all duration-300 p-6 h-full flex flex-col group hover:shadow-lg">
                    {/* Quote icon */}
                    <div className="mb-4">
