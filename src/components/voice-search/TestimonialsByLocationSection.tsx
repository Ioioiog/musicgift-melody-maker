...
const TestimonialsByLocationSection = () => {
  ...
  const getTestimonialsByLocation = () => {
    ...
    const approvedWithLocation = testimonials.filter(
      testimonial => testimonial.approved && testimonial.location && testimonial.location.trim()
    );
    ...
    <Card className="bg-gradient-to-r from-blue-500/5 to-purple-500/5 border-blue-200 mb-12">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {locationTestimonials.map((item, index) => (
            <div key={index} className="bg-white/80 rounded-lg p-5 hover:bg-white/95 transition-colors border border-gray-100 shadow-sm">
              ...
              {item.testimonial.youtube_link && (
                <div className="text-center">
                  <a
                    href={item.testimonial.youtube_link}
                    target="_blank"
