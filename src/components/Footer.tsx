            ...
            <div className="flex space-x-3 sm:space-x-4">
              {[
                ...
                <a
                  key={label}
                  href={href}
                  className="w-8 h-8 sm:w-10 sm:h-10 bg-white/10 hover:bg-purple-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
                  aria-label={label}
                >
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                { to: "/packages", label: t('packages') || 'Packages' },
                { to: "/how-it-works", label: t('howItWorks') || 'How It Works' },
                { to: "/testimonials", label: t('testimonials') || 'Testimonials' },
                { to: "/admin", label: t('admin') || 'Admin' }
              ].map(({ to, label }) => (
                <li key={to}>
                  <Link
                    to={to}
                    className="text-gray-300 hover:text-purple-400 transition-all duration-300 hover:translate-x-2 inline-block relative group text-sm sm:text-base"
                  >
                    {label}
            ...
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                <a
                  key={text}
                  href={href}
                  className="flex items-center space-x-2 sm:space-x-3 text-gray-300 hover:text-purple-400 transition-colors duration-300 group text-sm sm:text-base"
                >
