            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  key={label}
                  href={href}
                  className="w-10 h-10 bg-white/10 hover:bg-purple-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 group"
                  aria-label={label}
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={to}>
                  <Link
                    to={to}
                    className="text-gray-300 hover:text-purple-400 transition-all duration-300 hover:translate-x-2 inline-block relative group"
                  >
                    {label}
