...
const Footer = () => {
  ...
  },
  {
    ...
    color: "hover:bg-gray-800"
                ...
                label,
                color
              }) => <a key={label} href={href} className={`w-11 h-11 bg-white/10 backdrop-blur-sm border border-black/10 ${color} rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:border-black/30 group`} aria-label={label}>
          ...
          <div className="space-y-6 py-[17px]">
            ...
            <div className="space-y-4">
              ...
              text,
              href
            }) => <a key={text} href={href} className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 transition-all duration-300 group p-3 rounded-xl hover:bg-white/10 backdrop-blur-sm border border-transparent hover:border-black/10">
