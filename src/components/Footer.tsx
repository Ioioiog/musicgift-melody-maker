...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer 
        className="relative text-gray-900 bg-cover bg-center bg-no-repeat"
        style={{
                  ...
                  <div className="flex space-x-3">
                    {[
                      ...
                      <a
                        key={label}
                        href={href}
                        className={`w-10 h-10 bg-gray-800/20 ${color} rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 backdrop-blur-sm`}
                        aria-label={label}
                      >
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={to}>
                      <Link
                        to={to}
                        className="text-gray-700 hover:text-gray-900 transition-colors duration-300 hover:translate-x-1 inline-block"
                      >
                        {label}
                      </Link>
                    </li>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  <li>
                    <button
                      onClick={openTerms}
                      className="text-gray-700 hover:text-gray-900 transition-colors duration-300 hover:translate-x-1 inline-block text-left"
                    >
                      {t('termsConditions')}
                    </button>
                  </li>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <a
                      key={text}
                      href={href}
                      className="flex items-start space-x-3 text-gray-700 hover:text-gray-900 transition-colors duration-300 group"
                    >
