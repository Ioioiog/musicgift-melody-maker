...
const Footer = () => {
  ...
  return <>
      ...
      <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
          ...
          <div className="py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-3">
                    ...
                    label,
                    color
                  }) => <a key={label} href={href} className={`w-10 h-10 bg-white/10 ${color} rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 backdrop-blur-sm`} aria-label={label}>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  ...
                  label
                      ...
                      <Link to={to} className="text-slate-300 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block">
                        {label}
                      </Link>
                    </li>)}
                </ul>
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  <li>
                    <button onClick={openTerms} className="text-slate-300 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block text-left">
                      {t('termsConditions')}
                    </button>
                  </li>
                  <li>
                    <button onClick={openPrivacy} className="text-slate-300 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block text-left">
                      {t('privacyPolicy')}
                    </button>
                  </li>
                  <li>
                    <button onClick={openRefund} className="text-slate-300 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block text-left">
                      {t('refundPolicy')}
                    </button>
                  </li>
                  <li>
                    <button onClick={openCookie} className="text-slate-300 hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block text-left">
                      {t('cookiePolicy')}
                    </button>
                  </li>
                </ul>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  text,
                  href
                }) => <a key={text} href={href} className="flex items-start space-x-3 text-slate-300 hover:text-white transition-colors duration-300 group">
        ...
        <LegalModals t={t} className="text-center px-0 mx-[222px] my-0 py-[36px] text-sm" />
      </footer>
    </>;
};
