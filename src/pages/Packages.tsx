...
const Packages = () => {
  ...
  const renderPackagePrice = (pkg: any) => {
    ...
    return (
      <div className="text-3xl font-bold text-white bg-orange-500 px-[12px] mx-[97px] text-center">
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-2 mb-6">
                        {pkg.includes?.map((item, itemIndex) => (
                          <li key={itemIndex} className="flex items-center justify-center text-center">
