        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {featuredStats.map((statIndex, index) => {
              ...
              return (
                <AnimatePresence key={`${statIndex}-${index}`} mode="wait">
                  <motion.div
            ...
            {stats.map((_, index) => (
              <motion.div
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  featuredStats.includes(index) ? 'bg-white scale-125' : 'bg-white/40'
                }`}
                animate={{
          ...
          <motion.div 
            className="overflow-hidden bg-white/10 rounded-full py-4 mb-8"
