...
const Contact = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden my-0 py-[5px]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-[16px]">
          <div className="max-w-5xl backdrop-blur-md shadow-xl rounded-2xl p-6 md:p-10 relative z-10 py-[11px] my-0 mx-[78px] px-[30px] bg-transparent">
              ...
              <div className="space-y-8">
                ...
                <div className="pt-8">
                  ...
                  <div className="flex space-x-4">
                    {["📘", "📷", "📺", "🎵"].map((icon, index) => <motion.button key={index} className="w-12 h-12 bg-purple-100 hover:bg-purple-200 rounded-full flex items-center justify-center text-xl transition-colors" whileHover={{
                    scale: 1.1
                  }} whileTap={{
                    scale: 0.95
                  }}>
