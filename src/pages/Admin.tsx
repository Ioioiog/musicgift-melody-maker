...
import { Package, Settings, FileText, ShoppingCart, GitBranch, CheckSquare } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage packages, fields, dependencies, and orders</p>
        </div>
